...
public class CurrentDTO {
	...
	public String toString() {
		return "CurrentDTO [observation_time=" + observation_time + ", temperature=" + temperature + ", weather_code="
				+ weather_code + ", weather_icons=" + Arrays.toString(weather_icons) + ", weather_descriptions="
				+ Arrays.toString(weather_descriptions) + ", wind_speed=" + wind_speed + ", wind_degree=" + wind_degree
				+ ", wind_dir=" + wind_dir + ", pressure=" + pressure + ", precip=" + precip + ", humidity=" + humidity
				+ ", cloudcover=" + cloudcover + ", feelslike=" + feelslike + ", uv_index=" + uv_index + ", visibility="
				+ visibility + ", is_day=" + is_day + "]";
	}
}
